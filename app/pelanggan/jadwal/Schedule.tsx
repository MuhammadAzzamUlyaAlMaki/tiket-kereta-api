...
const Schedule = (myProp: props) => {
    return (
        <div className="flex flex-wrap w-full border rounded-md shadow-md my-2">
            <div className="w-full md:3/12 p-3 flex flex-col">
            ...
            <div className="w-full md:4/12 p-3 flex flex-col">
            <small className="text-xs font-semibold text-sky-700">
                Unit Kereta
            </small>
            ...
            <strong>{myProp.item.price.toLocaleString(`en-US`, {style: `currency`, currency: `USD`})}</strong>
            </div>
